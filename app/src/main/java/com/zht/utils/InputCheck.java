...
/**
 * 作者：zhanghaitao on 2018/2/11 10:21
 * 邮箱：820159571@qq.com
 *
 * @describe:EditText的输入检测 + 字符检测
 */
...
public class InputCheck {
     ...
     * @param pwd  待检测密码
     * @return true - 符合密码规则;false - 不符合密码规则
     */
     ...
     * @return
     */
    public static boolean checkIdCardAfter6(String cardAfter6) {
     ...
     * @param edList  需监听的editText
     * @return  true 全部不为空 false含有空内容的EditText
     */
    public static boolean editListCheck(LinkedList<EditText> edList) {
